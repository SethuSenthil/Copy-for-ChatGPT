(async function () {
  ...
  const intervalId = window.setInterval(async function () {
    if (!document.querySelector('#copygpt-credits')) {
      document.querySelector('.text-center.text-xs').insertAdjacentHTML('beforeend', '&nbsp; ✨ <a class="underline" id="copygpt-credits" target="_blank" href="https://copygpt.sethusenthil.com/?ref=gptFooter"> Enhanced by CopyGPT</a>')
    }
